...
/**
 * Represents a Procesador de Texto question.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_textoprocesador_question extends question_graded_by_strategy implements question_response_answer_comparer {
  ...
  /** @var array of question_answer. */
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseenterananswer', 'qtype_textoprocesador');
    }
