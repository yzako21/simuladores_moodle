...
$string['pluginname'] = 'Browser Sim 2';
...
$string['cxneed'] = 'CX key is required to create the  GCS.';
$string['cxins'] = 'GCS';
$string['cxget'] = 'Use a google account to create one GCS (Google Custom Search) and get de variable cx';
