...
/**
 * Test helpers for the buscasim question type.
 *
 * @package    qtype_buscasim
...
/**
 * Test helper class for the buscasim question type.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_buscasim_test_helper extends question_test_helper {
    public function get_test_questions() {
        return array('frogtoad', 'frogonly', 'escapedwildcards');
    }

    /**
     * Makes a buscasim question with correct ansewer 'frog', partially
     * correct answer 'toad' and defaultmark 1. This question also has a
     * '*' match anything answer.
     * @return qtype_buscasim_question
     */
    public function make_buscasim_question_frogtoad() {
        question_bank::load_question_definition_classes('buscasim');
        $sa = new qtype_buscasim_question();
        ...
        $sa->qtype = question_bank::get_qtype('buscasim');

        return $sa;
    }

    /**
     * Gets the question data for a buscasim question with with correct
     * ansewer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_buscasim_question_data_frogtoad() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);

        $qdata->qtype = 'buscasim';
    ...
    /**
     * Gets the question form data for a buscasim question with with correct
     * answer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_buscasim_question_form_data_frogtoad() {
        $form = new stdClass();
    ...
    /**
     * Makes a buscasim question with just the correct ansewer 'frog', and
     * no other answer matching.
     * @return qtype_buscasim_question
     */
    public function make_buscasim_question_frogonly() {
        question_bank::load_question_definition_classes('buscasim');
        $sa = new qtype_buscasim_question();
        test_question_maker::initialise_a_question($sa);
        $sa->name = 'Short answer question';
    ...
    /**
     * Gets the question data for a buscasim questionwith just the correct
     * ansewer 'frog', and no other answer matching.
     * @return stdClass
     */
    public function get_buscasim_question_data_frogonly() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);
     ...
     * @return qtype_buscasim_question
     */
    public function make_buscasim_question_escapedwildcards() {
        question_bank::load_question_definition_classes('buscasim');
        $sa = new qtype_buscasim_question();
        test_question_maker::initialise_a_question($sa);
