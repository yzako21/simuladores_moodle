...
/**
 * hcalcsim Test question definition class.
 *
 * @package    qtype
 * @subpackage hcalcsim
...
/**
 * Represents a hcalcsim Test question.
 *
 * @copyright  2016 Moguel Pedraza Francisco Isaac / UNAM-DGTIC
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_hcalcsim_question extends question_graded_by_strategy implements question_response_answer_comparer {
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseenterananswer', 'qtype_hcalcsim');
    }
