...
/**
 * Question type class for the hcalcsim Test question type.
 *
 * @package    qtype
 * @subpackage hcalcsim
...
/**
 * The hcalcsim Test question type.
 *
 * @copyright  2016 Moguel Pedraza Francisco Isaac / UNAM-DGTIC
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_hcalcsim extends question_type {
    public function extra_question_fields() {
        //return array('qtype_hcalcsim_options', 'usecase');
        return array('qtype_hcalcsim_options', 'usecase','initsim','resultsim', 'restsim', 'answprev'); //-IS
    }
    ...
    */
    public function save_init_sim($question){
        ...
        $oldInitsim = $DB->get_record_select('qtype_hcalcsim_options',$select);    */
