...
/**
 * Test helpers for the hcalcsim question type.
 *
 * @package    qtype_hcalcsim
...
/**
 * Test helper class for the hcalcsim question type.
 *
 * @copyright  2016 Moguel Pedraza Francisco Isaac / UNAM-DGTIC
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_hcalcsim_test_helper extends question_test_helper {
    public function get_test_questions() {
        return array('frogtoad', 'frogonly', 'escapedwildcards');
    }

    /**     
     * @return qtype_hcalcsim_question
     */
    public function make_hcalcsim_question_frogtoad() {
        question_bank::load_question_definition_classes('hcalcsim');
        $sa = new qtype_hcalcsim_question();
        test_question_maker::initialise_a_question($sa);
        $sa->name = 'hcalcsim Test question';
        ...
        $sa->qtype = question_bank::get_qtype('hcalcsim');

        return $sa;
    }

    /**
     * Gets the question data for a hcalcsim question with with correct
     * ansewer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_hcalcsim_question_data_frogtoad() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);

        $qdata->qtype = 'hcalcsim';
        $qdata->name = 'hcalcsim Test question';
    ...
    /**
     * Gets the question form data for a hcalcsim question with with correct
     * answer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_hcalcsim_question_form_data_frogtoad() {
        $form = new stdClass();

        $form->name = 'hcalcsim Test question';
    ...
    /**
     * Makes a hcalcsim question with just the correct ansewer 'frog', and
     * no other answer matching.
     * @return qtype_hcalcsim_question
     */
    public function make_hcalcsim_question_frogonly() {
        question_bank::load_question_definition_classes('hcalcsim');
        $sa = new qtype_hcalcsim_question();
        test_question_maker::initialise_a_question($sa);
        $sa->name = 'hcalcsim Test question';
    ...
    /**
     * Gets the question data for a hcalcsim questionwith just the correct
     * ansewer 'frog', and no other answer matching.
     * @return stdClass
     */
    public function get_hcalcsim_question_data_frogonly() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);
     ...
     * @return qtype_hcalcsim_question
     */
    public function make_hcalcsim_question_escapedwildcards() {
        question_bank::load_question_definition_classes('hcalcsim');
        $sa = new qtype_hcalcsim_question();
        test_question_maker::initialise_a_question($sa);
