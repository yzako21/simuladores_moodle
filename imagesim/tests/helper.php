...
/**
 * Test helpers for the imagesim question type.
 *
 * @package    qtype_imagesim
...
/**
 * Test helper class for the imagesim question type.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_imagesim_test_helper extends question_test_helper {
    public function get_test_questions() {
        return array('frogtoad', 'frogonly', 'escapedwildcards');
    }

    /**
     * Makes a imagesim question with correct ansewer 'frog', partially
     * correct answer 'toad' and defaultmark 1. This question also has a
     * '*' match anything answer.
     * @return qtype_imagesim_question
     */
    public function make_imagesim_question_frogtoad() {
        question_bank::load_question_definition_classes('imagesim');
        $sa = new qtype_imagesim_question();
        ...
        $sa->qtype = question_bank::get_qtype('imagesim');

        return $sa;
    }

    /**
     * Gets the question data for a imagesim question with with correct
     * ansewer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_imagesim_question_data_frogtoad() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);

        $qdata->qtype = 'imagesim';
    ...
    /**
     * Gets the question form data for a imagesim question with with correct
     * answer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_imagesim_question_form_data_frogtoad() {
        $form = new stdClass();
    ...
    /**
     * Makes a imagesim question with just the correct ansewer 'frog', and
     * no other answer matching.
     * @return qtype_imagesim_question
     */
    public function make_imagesim_question_frogonly() {
        question_bank::load_question_definition_classes('imagesim');
        $sa = new qtype_imagesim_question();
        test_question_maker::initialise_a_question($sa);
        $sa->name = 'Short answer question';
    ...
    /**
     * Gets the question data for a imagesim questionwith just the correct
     * ansewer 'frog', and no other answer matching.
     * @return stdClass
     */
    public function get_imagesim_question_data_frogonly() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);
     ...
     * @return qtype_imagesim_question
     */
    public function make_imagesim_question_escapedwildcards() {
        question_bank::load_question_definition_classes('imagesim');
        $sa = new qtype_imagesim_question();
        test_question_maker::initialise_a_question($sa);
