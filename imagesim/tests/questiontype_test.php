...
/**
 * Unit tests for the imagesim question type class.
 *
...
global $CFG;
require_once($CFG->dirroot . '/question/type/imagesim/questiontype.php');
require_once($CFG->dirroot . '/question/engine/tests/helpers.php');
require_once($CFG->dirroot . '/question/type/edit_question_form.php');
require_once($CFG->dirroot . '/question/type/imagesim/edit_imagesim_form.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_imagesim_test extends advanced_testcase {
    public static $includecoverage = array(
        'question/type/questiontypebase.php',
        'question/type/imagesim/questiontype.php',
    );

    protected $qtype;

    protected function setUp() {
        $this->qtype = new qtype_imagesim();
    }
    ...
    protected function get_test_question_data() {
        return test_question_maker::get_question_data('imagesim');
    }

    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'imagesim');
    }
    ...
    public function test_get_random_guess_score() {
        $q = test_question_maker::get_question_data('imagesim');
    ...
    public function test_get_possible_responses_no_star() {
        $q = test_question_maker::get_question_data('imagesim', 'frogonly');
    ...
    public function test_question_saving_frogtoad() {
        ...
        $questiondata = test_question_maker::get_question_data('imagesim');
        $formdata = test_question_maker::get_question_form_data('imagesim');

        $generator = $this->getDataGenerator()->get_plugin_generator('core_question');
        $cat = $generator->create_question_category(array());

        $formdata->category = "{$cat->id},{$cat->contextid}";
        qtype_imagesim_edit_form::mock_submit((array)$formdata);

        $form = qtype_imagesim_test_helper::get_question_editing_form($cat, $questiondata);
